...
public class SnsAdaptorService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public SnsFriends getSnsFriends(SnsIdType snsIdType, String snsAccessToken, int startIdx, int limit) throws TalkException, org.apache.thrift.TException
    {
      sendGetSnsFriends(snsIdType, snsAccessToken, startIdx, limit);
      return recvGetSnsFriends();
    }

    public void sendGetSnsFriends(SnsIdType snsIdType, String snsAccessToken, int startIdx, int limit) throws org.apache.thrift.TException
    {
    ...
    public SnsFriends recvGetSnsFriends() throws TalkException, org.apache.thrift.TException
    {
    ...
    public SnsProfile getSnsMyProfile(SnsIdType snsIdType, String snsAccessToken) throws TalkException, org.apache.thrift.TException
    {
      sendGetSnsMyProfile(snsIdType, snsAccessToken);
      return recvGetSnsMyProfile();
    }

    public void sendGetSnsMyProfile(SnsIdType snsIdType, String snsAccessToken) throws org.apache.thrift.TException
    {
    ...
    public SnsProfile recvGetSnsMyProfile() throws TalkException, org.apache.thrift.TException
    {
    ...
    public void postSnsInvitationMessage(SnsIdType snsIdType, String snsAccessToken, String toSnsUserId) throws TalkException, org.apache.thrift.TException
    {
      sendPostSnsInvitationMessage(snsIdType, snsAccessToken, toSnsUserId);
      recvPostSnsInvitationMessage();
    }

    public void sendPostSnsInvitationMessage(SnsIdType snsIdType, String snsAccessToken, String toSnsUserId) throws org.apache.thrift.TException
    {
    ...
    public void recvPostSnsInvitationMessage() throws TalkException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getSnsFriends_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public SnsFriends getResult() throws TalkException, org.apache.thrift.TException {
        ...
        return (new Client(prot)).recvGetSnsFriends();
      }
    }
    ...
    public static class getSnsMyProfile_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public SnsProfile getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recvGetSnsMyProfile();
      }
    }
    ...
    public static class postSnsInvitationMessage_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recvPostSnsInvitationMessage();
      }
    }
  ...
  public static class getSnsFriends_args implements org.apache.thrift.TBase<getSnsFriends_args, getSnsFriends_args._Fields>, java.io.Serializable, Cloneable, Comparable<getSnsFriends_args>   {
    ...
    private String snsAccessToken; // required
    ...
    public int hashCode() {
      ...
      boolean present_snsAccessToken = true && (isSetSnsAccessToken());
      list.add(present_snsAccessToken);
      if (present_snsAccessToken)
        list.add(snsAccessToken);
          ...
          switch (schemeField.id) {
            case 2: // SNS_ID_TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.snsIdType = com.linecorp.thrift.SnsIdType.findByValue(iprot.readI32());
  ...
  public static class getSnsFriends_result implements org.apache.thrift.TBase<getSnsFriends_result, getSnsFriends_result._Fields>, java.io.Serializable, Cloneable, Comparable<getSnsFriends_result>   {
    ...
    private SnsFriends success; // required
  ...
  public static class getSnsMyProfile_result implements org.apache.thrift.TBase<getSnsMyProfile_result, getSnsMyProfile_result._Fields>, java.io.Serializable, Cloneable, Comparable<getSnsMyProfile_result>   {
    ...
    private SnsProfile success; // required
    private TalkException e; // required
  ...
  public static class postSnsInvitationMessage_args implements org.apache.thrift.TBase<postSnsInvitationMessage_args, postSnsInvitationMessage_args._Fields>, java.io.Serializable, Cloneable, Comparable<postSnsInvitationMessage_args>   {
    ...
    private SnsIdType snsIdType; // required
    private String snsAccessToken; // required
    private String toSnsUserId; // required
    ...
    public int hashCode() {
      ...
      boolean present_toSnsUserId = true && (isSetToSnsUserId());
      list.add(present_toSnsUserId);
      if (present_toSnsUserId)
        list.add(toSnsUserId);
