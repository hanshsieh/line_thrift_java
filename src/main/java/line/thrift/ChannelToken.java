...
public class ChannelToken implements org.apache.thrift.TBase<ChannelToken, ChannelToken._Fields>, java.io.Serializable, Cloneable, Comparable<ChannelToken> {
  ...
  private String obsToken; // required
  private long expiration; // required
  private String refreshToken; // required
  private String channelAccessToken; // required
  ...
  public int hashCode() {
    ...
    boolean present_obsToken = true && (isSetObsToken());
    list.add(present_obsToken);
    if (present_obsToken)
      list.add(obsToken);
    ...
    boolean present_refreshToken = true && (isSetRefreshToken());
    list.add(present_refreshToken);
    if (present_refreshToken)
      list.add(refreshToken);

    boolean present_channelAccessToken = true && (isSetChannelAccessToken());
    list.add(present_channelAccessToken);
    if (present_channelAccessToken)
      list.add(channelAccessToken);
