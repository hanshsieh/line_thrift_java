...
public class WapInvitation implements org.apache.thrift.TBase<WapInvitation, WapInvitation._Fields>, java.io.Serializable, Cloneable, Comparable<WapInvitation> {
  ...
  private WapInvitationType type; // required
  private String inviteeEmail; // required
  private String inviterMid; // required
  private String roomMid; // required
  ...
  public int hashCode() {
    ...
    boolean present_inviteeEmail = true && (isSetInviteeEmail());
    list.add(present_inviteeEmail);
    if (present_inviteeEmail)
      list.add(inviteeEmail);

    boolean present_inviterMid = true && (isSetInviterMid());
    list.add(present_inviterMid);
    if (present_inviterMid)
      list.add(inviterMid);

    boolean present_roomMid = true && (isSetRoomMid());
    list.add(present_roomMid);
    if (present_roomMid)
      list.add(roomMid);
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.linecorp.thrift.WapInvitationType.findByValue(iprot.readI32());
