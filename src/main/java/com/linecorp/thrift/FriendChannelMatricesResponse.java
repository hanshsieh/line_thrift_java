...
public class FriendChannelMatricesResponse implements org.apache.thrift.TBase<FriendChannelMatricesResponse, FriendChannelMatricesResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FriendChannelMatricesResponse> {
  ...
  private long expires; // required
  private List<FriendChannelMatrix> matrices; // required
  ...
  public void setMatrices(List<FriendChannelMatrix> matrices) {
    this.matrices = matrices;
  }
  ...
  public int hashCode() {
    ...
    boolean present_expires = true;
    list.add(present_expires);
    if (present_expires)
      list.add(expires);

    boolean present_matrices = true && (isSetMatrices());
    list.add(present_matrices);
    if (present_matrices)
      list.add(matrices);
