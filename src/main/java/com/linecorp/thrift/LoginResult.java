...
public class LoginResult implements org.apache.thrift.TBase<LoginResult, LoginResult._Fields>, java.io.Serializable, Cloneable, Comparable<LoginResult> {
  ...
  private String certificate; // required
  private String verifier; // required
  private String pinCode; // required
  private LoginResultType type; // required
  ...
  public int hashCode() {
    ...
    boolean present_pinCode = true && (isSetPinCode());
    list.add(present_pinCode);
    if (present_pinCode)
      list.add(pinCode);
        ...
        switch (schemeField.id) {
          ...
          case 5: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.linecorp.thrift.LoginResultType.findByValue(iprot.readI32());
