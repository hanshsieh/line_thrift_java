        ...
        switch (schemeField.id) {
          case 1: // CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.code = com.linecorp.thrift.ErrorCode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new HashMap<String,String>(2*_map316.size);
                String _key317;
                String _val318;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TalkException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter320 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (Map.Entry<String, String> _iter321 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new HashMap<String,String>(2*_map322.size);
          String _key323;
          String _val324;
