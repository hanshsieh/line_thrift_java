...
public class RSAKey implements org.apache.thrift.TBase<RSAKey, RSAKey._Fields>, java.io.Serializable, Cloneable, Comparable<RSAKey> {
  ...
  private String keynm; // required
  private String nvalue; // required
  private String evalue; // required
  private String sessionKey; // required
  ...
  public int hashCode() {
    ...
    boolean present_keynm = true && (isSetKeynm());
    list.add(present_keynm);
    if (present_keynm)
      list.add(keynm);

    boolean present_nvalue = true && (isSetNvalue());
    list.add(present_nvalue);
    if (present_nvalue)
      list.add(nvalue);

    boolean present_evalue = true && (isSetEvalue());
    list.add(present_evalue);
    if (present_evalue)
      list.add(evalue);
