...
public class AccountSupervisorService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    {
      sendGetRSAKey();
      return recvGetRSAKey();
    }

    public void sendGetRSAKey() throws org.apache.thrift.TException
    {
      getRSAKey_args args = new getRSAKey_args();
      sendBase("getRSAKey", args);
    }

    public RSAKey recvGetRSAKey() throws TalkException, org.apache.thrift.TException
    {
    ...
    public void notifyEmailConfirmationResult(Map<String,String> parameterMap) throws TalkException, org.apache.thrift.TException
    {
      sendNotifyEmailConfirmationResult(parameterMap);
      recvNotifyEmailConfirmationResult();
    }

    public void sendNotifyEmailConfirmationResult(Map<String,String> parameterMap) throws org.apache.thrift.TException
    {
    ...
    public void recvNotifyEmailConfirmationResult() throws TalkException, org.apache.thrift.TException
    {
    ...
    public String registerVirtualAccount(String locale, String encryptedVirtualUserId, String encryptedPassword) throws TalkException, org.apache.thrift.TException
    {
      sendRegisterVirtualAccount(locale, encryptedVirtualUserId, encryptedPassword);
      return recvRegisterVirtualAccount();
    }

    public void sendRegisterVirtualAccount(String locale, String encryptedVirtualUserId, String encryptedPassword) throws org.apache.thrift.TException
    {
    ...
    public String recvRegisterVirtualAccount() throws TalkException, org.apache.thrift.TException
    {
    ...
    public void requestVirtualAccountPasswordChange(String virtualMid, String encryptedVirtualUserId, String encryptedOldPassword, String encryptedNewPassword) throws TalkException, org.apache.thrift.TException
    {
      sendRequestVirtualAccountPasswordChange(virtualMid, encryptedVirtualUserId, encryptedOldPassword, encryptedNewPassword);
      recvRequestVirtualAccountPasswordChange();
    }

    public void sendRequestVirtualAccountPasswordChange(String virtualMid, String encryptedVirtualUserId, String encryptedOldPassword, String encryptedNewPassword) throws org.apache.thrift.TException
    {
    ...
    public void recvRequestVirtualAccountPasswordChange() throws TalkException, org.apache.thrift.TException
    {
    ...
    public void requestVirtualAccountPasswordSet(String virtualMid, String encryptedVirtualUserId, String encryptedNewPassword) throws TalkException, org.apache.thrift.TException
    {
      sendRequestVirtualAccountPasswordSet(virtualMid, encryptedVirtualUserId, encryptedNewPassword);
      recvRequestVirtualAccountPasswordSet();
    }

    public void sendRequestVirtualAccountPasswordSet(String virtualMid, String encryptedVirtualUserId, String encryptedNewPassword) throws org.apache.thrift.TException
    {
    ...
    public void recvRequestVirtualAccountPasswordSet() throws TalkException, org.apache.thrift.TException
    {
    ...
    public void unregisterVirtualAccount(String virtualMid) throws TalkException, org.apache.thrift.TException
    {
      sendUnregisterVirtualAccount(virtualMid);
      recvUnregisterVirtualAccount();
    }

    public void sendUnregisterVirtualAccount(String virtualMid) throws org.apache.thrift.TException
    {
    ...
    public void recvUnregisterVirtualAccount() throws TalkException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getRSAKey_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public RSAKey getResult() throws TalkException, org.apache.thrift.TException {
        ...
        return (new Client(prot)).recvGetRSAKey();
      }
    }
    ...
    public static class notifyEmailConfirmationResult_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recvNotifyEmailConfirmationResult();
      }
    }
    ...
    public static class registerVirtualAccount_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public String getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recvRegisterVirtualAccount();
      }
    }
    ...
    public static class requestVirtualAccountPasswordChange_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recvRequestVirtualAccountPasswordChange();
      }
    }
    ...
    public static class requestVirtualAccountPasswordSet_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recvRequestVirtualAccountPasswordSet();
      }
    }
    ...
    public static class unregisterVirtualAccount_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recvUnregisterVirtualAccount();
      }
    }
...
;
  ...
  public static class getRSAKey_result implements org.apache.thrift.TBase<getRSAKey_result, getRSAKey_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRSAKey_result>   {
    ...
    private RSAKey success; // required
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.parameterMap = new HashMap<String,String>(2*_map376.size);
                  String _key377;
                  String _val378;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, notifyEmailConfirmationResult_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.parameterMap != null) {
          oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter380 : struct.parameterMap.entrySet())
            {
        ...
        if (struct.isSetParameterMap()) {
          {
            ...
            for (Map.Entry<String, String> _iter381 : struct.parameterMap.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.parameterMap = new HashMap<String,String>(2*_map382.size);
            String _key383;
            String _val384;
  ...
  public static class registerVirtualAccount_args implements org.apache.thrift.TBase<registerVirtualAccount_args, registerVirtualAccount_args._Fields>, java.io.Serializable, Cloneable, Comparable<registerVirtualAccount_args>   {
    ...
    private String encryptedVirtualUserId; // required
    private String encryptedPassword; // required
    ...
    public int hashCode() {
      ...
      boolean present_encryptedVirtualUserId = true && (isSetEncryptedVirtualUserId());
      list.add(present_encryptedVirtualUserId);
      if (present_encryptedVirtualUserId)
        list.add(encryptedVirtualUserId);
  ...
  public static class requestVirtualAccountPasswordChange_args implements org.apache.thrift.TBase<requestVirtualAccountPasswordChange_args, requestVirtualAccountPasswordChange_args._Fields>, java.io.Serializable, Cloneable, Comparable<requestVirtualAccountPasswordChange_args>   {
    ...
    private String virtualMid; // required
    private String encryptedVirtualUserId; // required
    private String encryptedOldPassword; // required
    private String encryptedNewPassword; // required
    ...
    public int hashCode() {
      ...
      boolean present_virtualMid = true && (isSetVirtualMid());
      list.add(present_virtualMid);
      if (present_virtualMid)
        list.add(virtualMid);
      ...
      boolean present_encryptedOldPassword = true && (isSetEncryptedOldPassword());
      list.add(present_encryptedOldPassword);
      if (present_encryptedOldPassword)
        list.add(encryptedOldPassword);

      boolean present_encryptedNewPassword = true && (isSetEncryptedNewPassword());
      list.add(present_encryptedNewPassword);
      if (present_encryptedNewPassword)
        list.add(encryptedNewPassword);
