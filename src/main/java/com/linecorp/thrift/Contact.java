...
public class Contact implements org.apache.thrift.TBase<Contact, Contact._Fields>, java.io.Serializable, Cloneable, Comparable<Contact> {
  ...
  private ContactRelation relation; // required
  ...
  private long favoriteTime; // required
  private boolean capableVoiceCall; // required
  private boolean capableVideoCall; // required
  private boolean capableMyhome; // required
  private boolean capableBuddy; // required
  private int attributes; // required
  ...
  public int hashCode() {
    ...
    boolean present_favoriteTime = true;
    list.add(present_favoriteTime);
    if (present_favoriteTime)
      list.add(favoriteTime);

    boolean present_capableVoiceCall = true;
    list.add(present_capableVoiceCall);
    if (present_capableVoiceCall)
      list.add(capableVoiceCall);

    boolean present_capableVideoCall = true;
    list.add(present_capableVideoCall);
    if (present_capableVideoCall)
      list.add(capableVideoCall);
    ...
    boolean present_capableBuddy = true;
    list.add(present_capableBuddy);
    if (present_capableBuddy)
      list.add(capableBuddy);

    boolean present_attributes = true;
        ...
        switch (schemeField.id) {
          ...
          case 10: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.linecorp.thrift.ContactType.findByValue(iprot.readI32());
          ...
          case 11: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = com.linecorp.thrift.ContactStatus.findByValue(iprot.readI32());
          ...
          case 21: // RELATION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.relation = com.linecorp.thrift.ContactRelation.findByValue(iprot.readI32());
