...
public class ProductList implements org.apache.thrift.TBase<ProductList, ProductList._Fields>, java.io.Serializable, Cloneable, Comparable<ProductList> {
  ...
  private long bannerSequence; // required
  private ProductBannerLinkType bannerTargetType; // required
  private String bannerTargetPath; // required
  private List<Product> productList; // required
  private String bannerLang; // required
  ...
  public int hashCode() {
    ...
    boolean present_bannerSequence = true;
    list.add(present_bannerSequence);
    if (present_bannerSequence)
      list.add(bannerSequence);

    boolean present_bannerTargetType = true && (isSetBannerTargetType());
    list.add(present_bannerTargetType);
    if (present_bannerTargetType)
      list.add(bannerTargetType.getValue());

    boolean present_bannerTargetPath = true && (isSetBannerTargetPath());
    list.add(present_bannerTargetPath);
    if (present_bannerTargetPath)
      list.add(bannerTargetPath);
    ...
    boolean present_bannerLang = true && (isSetBannerLang());
    list.add(present_bannerLang);
    if (present_bannerLang)
      list.add(bannerLang);
        ...
        switch (schemeField.id) {
          ...
          case 5: // BANNER_TARGET_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.bannerTargetType = com.linecorp.thrift.ProductBannerLinkType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new ArrayList<Product>(_list248.size);
                Product _elem249;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.productList = new ArrayList<Product>(_list253.size);
          Product _elem254;
