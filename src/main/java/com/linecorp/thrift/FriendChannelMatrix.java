...
public class FriendChannelMatrix implements org.apache.thrift.TBase<FriendChannelMatrix, FriendChannelMatrix._Fields>, java.io.Serializable, Cloneable, Comparable<FriendChannelMatrix> {
  ...
  private String representMid; // required
  ...
  public int hashCode() {
    ...
    boolean present_representMid = true && (isSetRepresentMid());
    list.add(present_representMid);
    if (present_representMid)
      list.add(representMid);
