...
public class MessageOperations implements org.apache.thrift.TBase<MessageOperations, MessageOperations._Fields>, java.io.Serializable, Cloneable, Comparable<MessageOperations> {
  ...
  private List<MessageOperation> operations; // required
  private boolean endFlag; // required
  ...
  public int hashCode() {
    ...
    boolean present_endFlag = true;
    list.add(present_endFlag);
    if (present_endFlag)
      list.add(endFlag);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.operations = new ArrayList<MessageOperation>(_list202.size);
                MessageOperation _elem203;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.operations = new ArrayList<MessageOperation>(_list207.size);
          MessageOperation _elem208;
