...
public class Operation implements org.apache.thrift.TBase<Operation, Operation._Fields>, java.io.Serializable, Cloneable, Comparable<Operation> {
  ...
  private OpType type; // required
  private int reqSeq; // required
  private String checksum; // required
  private OpStatus status; // required
  ...
  public int hashCode() {
    ...
    boolean present_reqSeq = true;
    list.add(present_reqSeq);
    if (present_reqSeq)
      list.add(reqSeq);
        ...
        switch (schemeField.id) {
          ...
          case 3: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = com.linecorp.thrift.OpType.findByValue(iprot.readI32());
          ...
          case 7: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status = com.linecorp.thrift.OpStatus.findByValue(iprot.readI32());
