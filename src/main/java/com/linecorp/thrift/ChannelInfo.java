...
public class ChannelInfo implements org.apache.thrift.TBase<ChannelInfo, ChannelInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ChannelInfo> {
  ...
  private String entryPageUrl; // required
  private String descriptionText; // required
  private ChannelProvider provider; // required
  private PublicType publicType; // required
  private String iconImage; // required
  private List<String> permissions; // required
  private String iconThumbnailImage; // required
  private List<ChannelConfiguration> channelConfigurations; // required
  ...
  public int hashCode() {
    ...
    boolean present_entryPageUrl = true && (isSetEntryPageUrl());
    list.add(present_entryPageUrl);
    if (present_entryPageUrl)
      list.add(entryPageUrl);
    ...
    boolean present_publicType = true && (isSetPublicType());
    list.add(present_publicType);
    if (present_publicType)
      list.add(publicType.getValue());

    boolean present_iconImage = true && (isSetIconImage());
    list.add(present_iconImage);
    if (present_iconImage)
      list.add(iconImage);
    ...
    boolean present_iconThumbnailImage = true && (isSetIconThumbnailImage());
    list.add(present_iconThumbnailImage);
    if (present_iconThumbnailImage)
      list.add(iconThumbnailImage);

    boolean present_channelConfigurations = true && (isSetChannelConfigurations());
    list.add(present_channelConfigurations);
    if (present_channelConfigurations)
      list.add(channelConfigurations);
        ...
        switch (schemeField.id) {
          ...
          case 7: // PUBLIC_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.publicType = com.linecorp.thrift.PublicType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                ChannelConfiguration _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = com.linecorp.thrift.ChannelConfiguration.findByValue(iprot.readI32());
      ...
      if (incoming.get(9)) {
        {
          ...
          ChannelConfiguration _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = com.linecorp.thrift.ChannelConfiguration.findByValue(iprot.readI32());
