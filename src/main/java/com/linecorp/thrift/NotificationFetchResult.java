...
public class NotificationFetchResult implements org.apache.thrift.TBase<NotificationFetchResult, NotificationFetchResult._Fields>, java.io.Serializable, Cloneable, Comparable<NotificationFetchResult> {
  ...
  private NotificationItemFetchMode fetchMode; // required
  private List<NotificationItem> itemList; // required
  ...
  public void setItemList(List<NotificationItem> itemList) {
    this.itemList = itemList;
  }
  ...
  public int hashCode() {
    ...
    boolean present_fetchMode = true && (isSetFetchMode());
    list.add(present_fetchMode);
    if (present_fetchMode)
      list.add(fetchMode.getValue());
        ...
        switch (schemeField.id) {
          case 1: // FETCH_MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.fetchMode = com.linecorp.thrift.NotificationItemFetchMode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.itemList = new ArrayList<NotificationItem>(_list230.size);
                NotificationItem _elem231;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.itemList = new ArrayList<NotificationItem>(_list235.size);
          NotificationItem _elem236;
