        ...
        switch (schemeField.id) {
          ...
          case 40: // IDENTITY_PROVIDER
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.identityProvider = line.thrift.IdentityProvider.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  _key289 = line.thrift.SnsIdType.findByValue(iprot.readI32());
          ...
          case 44: // EMAIL_CONFIRMATION_STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.emailConfirmationStatus = line.thrift.EmailConfirmationStatus.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  _key293 = line.thrift.CustomMode.findByValue(iprot.readI32());
      ...
      if (incoming.get(19)) {
        {
          ...
          {
            _key301 = line.thrift.SnsIdType.findByValue(iprot.readI32());
      ...
      if (incoming.get(23)) {
        {
          ...
          {
            _key305 = line.thrift.CustomMode.findByValue(iprot.readI32());
