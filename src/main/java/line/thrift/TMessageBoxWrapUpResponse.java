...
public class TMessageBoxWrapUpResponse implements org.apache.thrift.TBase<TMessageBoxWrapUpResponse, TMessageBoxWrapUpResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TMessageBoxWrapUpResponse> {
  ...
  private List<TMessageBoxWrapUp> messageBoxWrapUpList; // required
  private int totalSize; // required
  ...
  public void setMessageBoxWrapUpList(List<TMessageBoxWrapUp> messageBoxWrapUpList) {
    this.messageBoxWrapUpList = messageBoxWrapUpList;
  }
  ...
  public int hashCode() {
    ...
    boolean present_messageBoxWrapUpList = true && (isSetMessageBoxWrapUpList());
    list.add(present_messageBoxWrapUpList);
    if (present_messageBoxWrapUpList)
      list.add(messageBoxWrapUpList);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageBoxWrapUpList = new ArrayList<TMessageBoxWrapUp>(_list342.size);
                TMessageBoxWrapUp _elem343;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.messageBoxWrapUpList = new ArrayList<TMessageBoxWrapUp>(_list347.size);
          TMessageBoxWrapUp _elem348;
