...
public class SnsFriends implements org.apache.thrift.TBase<SnsFriends, SnsFriends._Fields>, java.io.Serializable, Cloneable, Comparable<SnsFriends> {
  ...
  private List<SnsFriend> snsFriends; // required
  ...
  public void setSnsFriends(List<SnsFriend> snsFriends) {
    this.snsFriends = snsFriends;
  }
  ...
  public int hashCode() {
    ...
    boolean present_snsFriends = true && (isSetSnsFriends());
    list.add(present_snsFriends);
    if (present_snsFriends)
      list.add(snsFriends);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.snsFriends = new ArrayList<SnsFriend>(_list308.size);
                SnsFriend _elem309;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.snsFriends = new ArrayList<SnsFriend>(_list313.size);
          SnsFriend _elem314;
