...
public class CoinHistoryResult implements org.apache.thrift.TBase<CoinHistoryResult, CoinHistoryResult._Fields>, java.io.Serializable, Cloneable, Comparable<CoinHistoryResult> {
  ...
  private List<CoinHistory> historys; // required
  private Coin balance; // required
  ...
  public void setHistorys(List<CoinHistory> historys) {
    this.historys = historys;
  }
  ...
  public int hashCode() {
    ...
    boolean present_historys = true && (isSetHistorys());
    list.add(present_historys);
    if (present_historys)
      list.add(historys);
