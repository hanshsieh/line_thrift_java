...
public class LoginSession implements org.apache.thrift.TBase<LoginSession, LoginSession._Fields>, java.io.Serializable, Cloneable, Comparable<LoginSession> {
  ...
  public int hashCode() {
    ...
    boolean present_tokenKey = true && (isSetTokenKey());
    list.add(present_tokenKey);
    if (present_tokenKey)
      list.add(tokenKey);
    ...
    boolean present_accessLocation = true && (isSetAccessLocation());
    list.add(present_accessLocation);
    if (present_accessLocation)
      list.add(accessLocation);
        ...
        switch (schemeField.id) {
          ...
          case 11: // APPLICATION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.applicationType = com.linecorp.thrift.ApplicationType.findByValue(iprot.readI32());
