...
public class AgeCheckService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public UserAgeType checkUserAge(CarrierCode carrier, String sessionId, String verifier, int standardAge) throws TalkException, org.apache.thrift.TException
    {
      sendCheckUserAge(carrier, sessionId, verifier, standardAge);
      return recvCheckUserAge();
    }

    public void sendCheckUserAge(CarrierCode carrier, String sessionId, String verifier, int standardAge) throws org.apache.thrift.TException
    {
    ...
    public UserAgeType recvCheckUserAge() throws TalkException, org.apache.thrift.TException
    {
    ...
    public AgeCheckDocomoResult checkUserAgeWithDocomo(String openIdRedirectUrl, int standardAge, String verifier) throws TalkException, org.apache.thrift.TException
    {
      sendCheckUserAgeWithDocomo(openIdRedirectUrl, standardAge, verifier);
      return recvCheckUserAgeWithDocomo();
    }

    public void sendCheckUserAgeWithDocomo(String openIdRedirectUrl, int standardAge, String verifier) throws org.apache.thrift.TException
    {
    ...
    public AgeCheckDocomoResult recvCheckUserAgeWithDocomo() throws TalkException, org.apache.thrift.TException
    {
    ...
    public String retrieveOpenIdAuthUrlWithDocomo() throws TalkException, org.apache.thrift.TException
    {
      sendRetrieveOpenIdAuthUrlWithDocomo();
      return recvRetrieveOpenIdAuthUrlWithDocomo();
    }

    public void sendRetrieveOpenIdAuthUrlWithDocomo() throws org.apache.thrift.TException
    {
    ...
    public String recvRetrieveOpenIdAuthUrlWithDocomo() throws TalkException, org.apache.thrift.TException
    {
    ...
    public AgeCheckRequestResult retrieveRequestToken(CarrierCode carrier) throws TalkException, org.apache.thrift.TException
    {
      sendRetrieveRequestToken(carrier);
      return recvRetrieveRequestToken();
    }

    public void sendRetrieveRequestToken(CarrierCode carrier) throws org.apache.thrift.TException
    {
    ...
    public AgeCheckRequestResult recvRetrieveRequestToken() throws TalkException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class checkUserAge_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public UserAgeType getResult() throws TalkException, org.apache.thrift.TException {
        ...
        return (new Client(prot)).recvCheckUserAge();
      }
    }
    ...
    public static class checkUserAgeWithDocomo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public AgeCheckDocomoResult getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recvCheckUserAgeWithDocomo();
      }
    }
    ...
    public static class retrieveOpenIdAuthUrlWithDocomo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public String getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recvRetrieveOpenIdAuthUrlWithDocomo();
      }
    }
    ...
    public static class retrieveRequestToken_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public AgeCheckRequestResult getResult() throws TalkException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recvRetrieveRequestToken();
      }
    }
  ...
  public static class checkUserAge_args implements org.apache.thrift.TBase<checkUserAge_args, checkUserAge_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkUserAge_args>   {
    ...
    private CarrierCode carrier; // required
    private String sessionId; // required
    private String verifier; // required
    private int standardAge; // required
    ...
    public int hashCode() {
      ...
      boolean present_standardAge = true;
      list.add(present_standardAge);
      if (present_standardAge)
        list.add(standardAge);
          ...
          switch (schemeField.id) {
            case 2: // CARRIER
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.carrier = com.linecorp.thrift.CarrierCode.findByValue(iprot.readI32());
  ...
  public static class checkUserAge_result implements org.apache.thrift.TBase<checkUserAge_result, checkUserAge_result._Fields>, java.io.Serializable, Cloneable, Comparable<checkUserAge_result>   {
    ...
    private UserAgeType success; // required
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, checkUserAge_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.success = com.linecorp.thrift.UserAgeType.findByValue(iprot.readI32());
  ...
  public static class checkUserAgeWithDocomo_args implements org.apache.thrift.TBase<checkUserAgeWithDocomo_args, checkUserAgeWithDocomo_args._Fields>, java.io.Serializable, Cloneable, Comparable<checkUserAgeWithDocomo_args>   {
    ...
    private String openIdRedirectUrl; // required
    private int standardAge; // required
    private String verifier; // required
    ...
    public int hashCode() {
      ...
      boolean present_openIdRedirectUrl = true && (isSetOpenIdRedirectUrl());
      list.add(present_openIdRedirectUrl);
      if (present_openIdRedirectUrl)
        list.add(openIdRedirectUrl);
  ...
  public static class checkUserAgeWithDocomo_result implements org.apache.thrift.TBase<checkUserAgeWithDocomo_result, checkUserAgeWithDocomo_result._Fields>, java.io.Serializable, Cloneable, Comparable<checkUserAgeWithDocomo_result>   {
    ...
    private AgeCheckDocomoResult success; // required
    private TalkException e; // required
...
;
  ...
  public static class retrieveRequestToken_result implements org.apache.thrift.TBase<retrieveRequestToken_result, retrieveRequestToken_result._Fields>, java.io.Serializable, Cloneable, Comparable<retrieveRequestToken_result>   {
    ...
    private AgeCheckRequestResult success; // required
    private TalkException e; // required
