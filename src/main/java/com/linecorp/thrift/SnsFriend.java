...
public class SnsFriend implements org.apache.thrift.TBase<SnsFriend, SnsFriend._Fields>, java.io.Serializable, Cloneable, Comparable<SnsFriend> {
  ...
  private String snsUserName; // required
  ...
  public int hashCode() {
    ...
    boolean present_snsUserName = true && (isSetSnsUserName());
    list.add(present_snsUserName);
    if (present_snsUserName)
      list.add(snsUserName);
