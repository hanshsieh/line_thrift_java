...
public class PaymentReservationResult implements org.apache.thrift.TBase<PaymentReservationResult, PaymentReservationResult._Fields>, java.io.Serializable, Cloneable, Comparable<PaymentReservationResult> {
  ...
  private String confirmUrl; // required
  private Map<String,String> extras; // required
  ...
  public int hashCode() {
    ...
    boolean present_confirmUrl = true && (isSetConfirmUrl());
    list.add(present_confirmUrl);
    if (present_confirmUrl)
      list.add(confirmUrl);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extras = new HashMap<String,String>(2*_map238.size);
                String _key239;
                String _val240;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaymentReservationResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.extras != null) {
        oprot.writeFieldBegin(EXTRAS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter242 : struct.extras.entrySet())
          {
      ...
      if (struct.isSetExtras()) {
        {
          ...
          for (Map.Entry<String, String> _iter243 : struct.extras.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.extras = new HashMap<String,String>(2*_map244.size);
          String _key245;
          String _val246;
