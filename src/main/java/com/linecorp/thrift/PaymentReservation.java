...
public class PaymentReservation implements org.apache.thrift.TBase<PaymentReservation, PaymentReservation._Fields>, java.io.Serializable, Cloneable, Comparable<PaymentReservation> {
  ...
  private String receiverMid; // required
  ...
  private int messageTemplate; // required
  ...
  public int hashCode() {
    ...
    boolean present_receiverMid = true && (isSetReceiverMid());
    list.add(present_receiverMid);
    if (present_receiverMid)
      list.add(receiverMid);
    ...
    list.add(present_messageText);
    if (present_messageText)
      list.add(messageText);

    boolean present_messageTemplate = true;
    list.add(present_messageTemplate);
    if (present_messageTemplate)
