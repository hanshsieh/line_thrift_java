...
public class ApprovedChannelInfos implements org.apache.thrift.TBase<ApprovedChannelInfos, ApprovedChannelInfos._Fields>, java.io.Serializable, Cloneable, Comparable<ApprovedChannelInfos> {
  ...
  private List<ApprovedChannelInfo> approvedChannelInfos; // required
  ...
  public void setApprovedChannelInfos(List<ApprovedChannelInfo> approvedChannelInfos) {
    this.approvedChannelInfos = approvedChannelInfos;
  }
  ...
  public int hashCode() {
    ...
    boolean present_approvedChannelInfos = true && (isSetApprovedChannelInfos());
    list.add(present_approvedChannelInfos);
    if (present_approvedChannelInfos)
      list.add(approvedChannelInfos);
