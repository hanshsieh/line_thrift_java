...
public class CoinHistory implements org.apache.thrift.TBase<CoinHistory, CoinHistory._Fields>, java.io.Serializable, Cloneable, Comparable<CoinHistory> {
  ...
  private long payDate; // required
  private int coinBalance; // required
  private int coin; // required
  private String price; // required
  private String title; // required
  private boolean refund; // required
  private String paySeq; // required
  private String currency; // required
  private String currencySign; // required
  private String displayPrice; // required
  private CoinPayLoad payload; // required
  ...
  public int hashCode() {
    ...
    boolean present_payDate = true;
    list.add(present_payDate);
    if (present_payDate)
      list.add(payDate);

    boolean present_coinBalance = true;
    list.add(present_coinBalance);
    if (present_coinBalance)
      list.add(coinBalance);
    ...
    boolean present_paySeq = true && (isSetPaySeq());
    list.add(present_paySeq);
    if (present_paySeq)
      list.add(paySeq);
    ...
    boolean present_currencySign = true && (isSetCurrencySign());
    list.add(present_currencySign);
    if (present_currencySign)
      list.add(currencySign);
