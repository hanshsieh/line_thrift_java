...
public class SnsIdUserStatus implements org.apache.thrift.TBase<SnsIdUserStatus, SnsIdUserStatus._Fields>, java.io.Serializable, Cloneable, Comparable<SnsIdUserStatus> {
  ...
  private boolean userExisting; // required
  private boolean phoneNumberRegistered; // required
  private boolean sameDevice; // required
  ...
  public int hashCode() {
    ...
    boolean present_userExisting = true;
    list.add(present_userExisting);
    if (present_userExisting)
      list.add(userExisting);
    ...
    boolean present_sameDevice = true;
    list.add(present_sameDevice);
    if (present_sameDevice)
      list.add(sameDevice);
