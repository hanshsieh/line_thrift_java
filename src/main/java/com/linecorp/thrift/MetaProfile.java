...
public class MetaProfile implements org.apache.thrift.TBase<MetaProfile, MetaProfile._Fields>, java.io.Serializable, Cloneable, Comparable<MetaProfile> {
  ...
  private Map<RegistrationType,String> identities; // required
  ...
  public void setIdentities(Map<RegistrationType,String> identities) {
    this.identities = identities;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.identities = new HashMap<RegistrationType,String>(2*_map210.size);
                RegistrationType _key211;
                String _val212;
                for (int _i213 = 0; _i213 < _map210.size; ++_i213)
                {
                  _key211 = com.linecorp.thrift.RegistrationType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MetaProfile struct) throws org.apache.thrift.TException {
      ...
      if (struct.identities != null) {
        oprot.writeFieldBegin(IDENTITIES_FIELD_DESC);
        {
          ...
          for (Map.Entry<RegistrationType, String> _iter214 : struct.identities.entrySet())
          {
      ...
      if (struct.isSetIdentities()) {
        {
          ...
          for (Map.Entry<RegistrationType, String> _iter215 : struct.identities.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.identities = new HashMap<RegistrationType,String>(2*_map216.size);
          RegistrationType _key217;
          String _val218;
          for (int _i219 = 0; _i219 < _map216.size; ++_i219)
          {
            _key217 = com.linecorp.thrift.RegistrationType.findByValue(iprot.readI32());
